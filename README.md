...
## Deploy no okteto
Para realizar o deploy no okteto utilizamos catálogo disponibilizado dentro da própria plataforma, como mostra a imagem abaixo, o qual se encarrega de construir imagens pré-definidas e disponibilizar os pods já funcionando.

![okteto catalogo](Assets/okteto_catalog.png)

Desse catálogo criamos não só um pod para o jupyter notebook, mas também um para o mongodb. Desse modo, ficou simples estabelecer uma conexão entre o jupyter notebook e o banco de dados.
...
Então, buscado por versões anteriores da documentação, encontramos a maneira correta para a versão 1.12, como mostra a figura abaixo
